...
public class CostDetails {
	...
	public void getCostdetailsPerHour() throws IOException{
		...
		ArrayList<NameValuePair> nameValuePairs1 = new ArrayList<NameValuePair>();		
		BufferedReader br =  new BufferedReader(new FileReader("/home/avadhoot/Desktop/EnergyScheduling/data.csv"));
		...
		PrintWriter out = new PrintWriter("/home/avadhoot/Desktop/EnergyScheduling/CostPerHour.txt");
		...
		for(String key : costPerHourHashMap.keySet()){
			...
			HttpPost httppost = new HttpPost("http://192.168.0.105/costdetails.php");
